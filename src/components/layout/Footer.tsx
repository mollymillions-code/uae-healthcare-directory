...
export function Footer() {
  ...
  return (
    <VideoFooterShell
      ...
      trustRail={
        <nav aria-labelledby="footer-trust-heading" className="border-t border-black/10 pt-4">
          <h3 id="footer-trust-heading" className={videoFooterHeadingClass}>
      ...
      discoveryRail={
        <nav aria-labelledby="footer-gcc-heading" className="border-t border-black/10 pt-4">
          <h3 id="footer-gcc-heading" className={videoFooterHeadingClass}>
