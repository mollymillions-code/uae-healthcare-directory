...
export default function EditorialPolicyPage() {
  ...
  return (
    <div className="container-tc py-8 pb-16">
      ...
      <h1 className="text-3xl font-bold text-dark mb-8">Editorial Policy</h1>
      ...
      <div className="max-w-3xl space-y-10">
        ...
        {/* Verification */}
        <section>
          <h2 className="text-lg font-medium text-dark mb-3">Verification</h2>
          <p className="text-sm text-muted leading-relaxed">
        ...
        {/* Corrections */}
        <section>
          <h2 className="text-lg font-medium text-dark mb-3">Corrections</h2>
          <p className="text-sm text-muted leading-relaxed">
        ...
        {/* Update Schedule */}
        <section>
          <h2 className="text-lg font-medium text-dark mb-3">Update Schedule</h2>
          <p className="text-sm text-muted leading-relaxed">
