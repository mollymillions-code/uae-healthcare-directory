/**
 * Dentist-only child sitemap. Referenced by /sitemap-doctors.xml (the
 * sitemap-index).
 *
 * Filters: status='active' AND discipline='dentist' AND
 *          specialty_slug IS NOT NULL.
 *
 * Cap matches the physicians child at 49,000 URLs.
 */
...
export async function GET() {
  ...
  try {
    ...
    console.error("[sitemap-doctors-dentists] Failed to generate:", error);
