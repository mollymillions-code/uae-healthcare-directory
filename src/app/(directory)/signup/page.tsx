      ...
      <div className="mx-auto grid max-w-[1320px] grid-cols-1 lg:min-h-screen lg:grid-cols-[1.05fr_1fr]">
        ...
        <main className="flex flex-col px-6 pb-12 pt-8 sm:px-10 lg:px-16 lg:pt-14 lg:pb-20">
          ...
          <div className="mt-12 max-w-[440px] lg:my-auto">
            ...
            <h1 className="mt-3 font-['Bricolage_Grotesque',sans-serif] text-[40px] font-medium leading-[1.05] tracking-[-0.02em] text-[#1c1c1c] sm:text-[44px]">
              Save what you find. Find it again later.
            </h1>
            <p className="mt-4 font-['Geist',sans-serif] text-base leading-relaxed text-black/55">
              A free Zavis account remembers your saved clinics, insurance preferences, and search history across devices.
            </p>
            ...
            <form onSubmit={handleSubmit} className="mt-10 space-y-5">
              ...
              <label className="flex items-start gap-3 rounded-xl border border-black/[0.06] bg-white px-4 py-3.5">
                <input
                  type="checkbox"
                ...
                />
                <span className="font-['Geist',sans-serif] text-[13px] leading-relaxed text-black/55">
                  Email me occasionally with useful Zavis updates — healthcare directory changes, insurance shifts, and new clinic listings. No spam.
                </span>
              </label>
