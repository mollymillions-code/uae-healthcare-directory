...
export function DirectoryHomeHero({ totalProviders }: Props) {
  return (
    <section className="relative overflow-hidden bg-surface-cream">
      ...
      <div className="relative max-w-z-container mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-20 pb-16 sm:pb-24 text-center">
        <div className="inline-flex items-center gap-2 rounded-z-pill bg-white/85 backdrop-blur border border-ink-line pl-1 pr-3 py-1 mb-6 shadow-z-card">
        ...
        <h1 className="font-display font-semibold text-ink text-[44px] xs:text-[52px] sm:text-[64px] lg:text-display-xl leading-[1.02] tracking-[-0.035em] max-w-[14ch] mx-auto">
          Find trusted care,
          <br />
        ...
        <p className="font-sans text-ink-soft text-z-body sm:text-[17px] mt-5 max-w-xl mx-auto leading-relaxed">
          Browse{" "}
