...
const GUIDE_ARTICLES: GuideArticle[] = [
  {
    ...
    body: [
      ...
      "The UAE has invested heavily in healthcare infrastructure over the past two decades, attracting internationally trained physicians and establishing world-class facilities. <a href=\"/directory/dubai\" class=\"text-[#006828] hover:underline\">Dubai</a> and <a href=\"/directory/abu-dhabi\" class=\"text-[#006828] hover:underline\">Abu Dhabi</a> are home to JCI-accredited hospitals, medical free zones like Dubai Healthcare City (DHCC), and research institutions. The country continues to pursue its goal of becoming a regional hub for medical tourism and specialised care.",
    ],
    faqs: [
      {
  ...
  },
  {
    ...
    body: [
      ...
      "When choosing a health insurance plan, consider the network of hospitals and clinics included, co-payment amounts, annual coverage limits, and whether pre-existing conditions are covered. Most insurers in the UAE partner with major hospital groups and clinic chains. You can use the <a href=\"/directory/dubai\" class=\"text-[#006828] hover:underline\">directory</a> to find providers in your city and check which insurance networks they accept. To verify your coverage status, contact your insurer directly or check through the DHA or DOH online portals.",
    ],
    faqs: [
      {
  ...
  },
  {
    ...
    body: [
      "The Ministry of Health and Prevention (MOHAP) is the UAE's federal government body responsible for healthcare policy, regulation, and public health at the national level. While DHA and DOH handle healthcare regulation in Dubai and Abu Dhabi respectively, MOHAP directly regulates the healthcare sector in the five Northern Emirates: <a href=\"/directory/sharjah\" class=\"text-[#006828] hover:underline\">Sharjah</a>, <a href=\"/directory/ajman\" class=\"text-[#006828] hover:underline\">Ajman</a>, <a href=\"/directory/ras-al-khaimah\" class=\"text-[#006828] hover:underline\">Ras Al Khaimah</a>, <a href=\"/directory/fujairah\" class=\"text-[#006828] hover:underline\">Fujairah</a>, and <a href=\"/directory/umm-al-quwain\" class=\"text-[#006828] hover:underline\">Umm Al Quwain</a>.",
  ...
  },
  {
    ...
    body: [
      "Finding the right doctor in the UAE starts with understanding your needs. If you require a general check-up, a general practitioner (GP) at a nearby clinic is usually sufficient. For specialist care — such as cardiology, orthopaedics, or dermatology — you will need a referral from your GP or can book directly with a specialist if your insurance plan allows direct access. Use the <a href=\"/directory/dubai\" class=\"text-[#006828] hover:underline\">UAE Open Healthcare Directory</a> to search by city, specialty, and area.",
      "Always verify that your chosen doctor is licensed by the relevant authority: DHA for <a href=\"/directory/dubai\" class=\"text-[#006828] hover:underline\">Dubai</a>, DOH for <a href=\"/directory/abu-dhabi\" class=\"text-[#006828] hover:underline\">Abu Dhabi</a> and <a href=\"/directory/al-ain\" class=\"text-[#006828] hover:underline\">Al Ain</a>, or MOHAP for the Northern Emirates. You can check licensing status through each authority's website or app. It is also important to confirm that the doctor and facility are within your insurance network — visiting an out-of-network provider can result in significantly higher out-of-pocket costs or no coverage at all.",
  ...
  },
  {
    ...
    body: [
      "In a medical emergency in the UAE, call 998 for ambulance services (or 999 for police and general emergencies). The national ambulance service operates across all seven Emirates, and response times in urban areas like <a href=\"/directory/dubai\" class=\"text-[#006828] hover:underline\">Dubai</a> and <a href=\"/directory/abu-dhabi\" class=\"text-[#006828] hover:underline\">Abu Dhabi</a> are among the fastest in the region. Dubai also operates the DHA-run Rashid Hospital Trauma Centre, one of the leading trauma facilities in the Middle East, specialising in road accident injuries, burns, and critical care.",
    ...
    <>
      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="max-w-3xl">
          <h1 className="font-['Bricolage_Grotesque',sans-serif] font-medium text-[28px] sm:text-[34px] text-[#1c1c1c] tracking-tight mb-6">{article.title}</h1>
