...
const GUIDE_ARTICLES: GuideArticle[] = [
  {
    ...
    body: [
      ...
      "The UAE has invested heavily in healthcare infrastructure over the past two decades, attracting internationally trained physicians and establishing world-class facilities. <a href=\"/directory/dubai\" class=\"text-accent hover:underline\">Dubai</a> and <a href=\"/directory/abu-dhabi\" class=\"text-accent hover:underline\">Abu Dhabi</a> are home to JCI-accredited hospitals, medical free zones like Dubai Healthcare City (DHCC), and research institutions. The country continues to pursue its goal of becoming a regional hub for medical tourism and specialised care.",
    ],
    faqs: [
      {
  ...
  },
  {
    ...
    body: [
      ...
      "When choosing a health insurance plan, consider the network of hospitals and clinics included, co-payment amounts, annual coverage limits, and whether pre-existing conditions are covered. Most insurers in the UAE partner with major hospital groups and clinic chains. You can use the <a href=\"/directory/dubai\" class=\"text-accent hover:underline\">directory</a> to find providers in your city and check which insurance networks they accept. To verify your coverage status, contact your insurer directly or check through the DHA or DOH online portals.",
    ],
    faqs: [
      {
  ...
  },
  {
    ...
    body: [
      "The Ministry of Health and Prevention (MOHAP) is the UAE's federal government body responsible for healthcare policy, regulation, and public health at the national level. While DHA and DOH handle healthcare regulation in Dubai and Abu Dhabi respectively, MOHAP directly regulates the healthcare sector in the five Northern Emirates: <a href=\"/directory/sharjah\" class=\"text-accent hover:underline\">Sharjah</a>, <a href=\"/directory/ajman\" class=\"text-accent hover:underline\">Ajman</a>, <a href=\"/directory/ras-al-khaimah\" class=\"text-accent hover:underline\">Ras Al Khaimah</a>, <a href=\"/directory/fujairah\" class=\"text-accent hover:underline\">Fujairah</a>, and <a href=\"/directory/umm-al-quwain\" class=\"text-accent hover:underline\">Umm Al Quwain</a>.",
  ...
  },
  {
    ...
    body: [
      "In a medical emergency in the UAE, call 998 for ambulance services (or 999 for police and general emergencies). The national ambulance service operates across all seven Emirates, and response times in urban areas like <a href=\"/directory/dubai\" class=\"text-accent hover:underline\">Dubai</a> and <a href=\"/directory/abu-dhabi\" class=\"text-accent hover:underline\">Abu Dhabi</a> are among the fastest in the region. Dubai also operates the DHA-run Rashid Hospital Trauma Centre, one of the leading trauma facilities in the Middle East, specialising in road accident injuries, burns, and critical care.",
