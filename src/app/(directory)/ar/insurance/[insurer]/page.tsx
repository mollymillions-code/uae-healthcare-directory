...
export default async function ArabicInsurerDetailPage({ params }: Props) {
  ...
  try {
    ...
    console.error(`[ar/insurance/${params.insurer}] Failed to load network stats:`, e instanceof Error ? e.message : e);
  }
  const base = getBaseUrl();
    ...
    <div className="container-tc py-8" dir="rtl">
      ...
      {await (async () => {
        ...
        try {
          ...
          console.error(`[ar/insurance/${params.insurer}] Failed to load all insurer stats:`, e instanceof Error ? e.message : e);
          return null;
        }
