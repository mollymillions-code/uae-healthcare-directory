...
const TEST_INTERPRETATIONS: Record<string, TestInterpretation> = {
  ...
  "lipid-profile": {
    ...
    nextSteps:
      "For borderline or high LDL: lifestyle modification is first-line — adopt a Mediterranean-style diet, reduce saturated and trans fats, increase soluble fibre (oats, legumes), exercise 150 minutes weekly, and lose weight if BMI is elevated. Retest after 3 months of lifestyle changes. If LDL remains above target despite lifestyle modification, or if cardiovascular risk is high, statin therapy is typically initiated. For high triglycerides: reduce refined carbohydrates, sugar, and alcohol; omega-3 fatty acid supplements (2–4 g EPA/the UAE healthcare regulator daily) are effective at triglyceride levels above 500 mg/dL.",
  ...
  "hiv-test": {
    ...
    whenToWorry:
      "If you receive a reactive HIV screening result, do not panic — confirmatory testing is required. Contact your doctor or a UAE healthcare regulator/the UAE healthcare regulator HIV clinic immediately for confirmatory testing and counselling. If you believe you had a high-risk exposure within the past 72 hours, seek emergency medical care immediately for PEP (post-exposure prophylaxis) — a 28-day antiretroviral course that can prevent HIV infection if started promptly. All pregnant women who are HIV positive require immediate antiretroviral therapy to prevent mother-to-child transmission.",
    uaeContext:
      "HIV testing is mandatory in the UAE for visa and residency permit applications. A confirmed positive result historically led to deportation — a policy that deterred voluntary testing among at-risk expat populations. UAE law and policy have evolved, and treatment is available at government hospitals; the UAE healthcare regulator and the UAE healthcare regulator run HIV/AIDS treatment programmes. Testing is available at all major UAE labs and is included in visa medical packages conducted at the UAE healthcare regulator-authorised screening centres. Results are treated with strict confidentiality at licensed facilities. UAE public health campaigns have increasingly emphasised HIV testing as a routine health matter, and some private clinics offer anonymous testing.",
    nextSteps:
