...
const TEST_MEDICAL_CONTENT: Record<string, TestMedicalContent> = {
  ...
  hba1c: {
    ...
    uaeContext:
      "The UAE has one of the highest diabetes prevalence rates globally — approximately 17% of adults have diagnosed diabetes, and up to 25% have pre-diabetes, according to the International Diabetes Federation. A significant portion remains undiagnosed. UAE health authorities actively promote diabetes screening through the annual National Health Survey and employer wellness mandates. HbA1c is included in most UAE corporate health check packages and is covered under the Essential Benefits Plan for insured employees. The UAE healthcare regulator's Dubai Diabetes Programme offers subsidised testing at primary health care centres.",
  },
  "thyroid-panel": {
    whatItMeasures:
  ...
  kft: {
    ...
    uaeContext:
      "Chronic kidney disease is a growing concern in the UAE, directly linked to the high prevalence of diabetes and hypertension. The UAE Renal Registry reports approximately 1,200 new patients commencing dialysis annually, with diabetic nephropathy accounting for the largest share. The UAE national insurance mandate means KFTs are typically covered under corporate health plans, and early CKD detection is a priority in the UAE healthcare regulator and the UAE healthcare regulator primary care guidelines. Uric acid is often added to KFT panels in the UAE given high rates of gout in the South Asian male expat population.",
  },
  "iron-studies": {
    whatItMeasures:
  ...
  "hiv-test": {
    ...
    uaeContext:
      "HIV testing is mandatory in the UAE for visa and residency permit applications — a positive result leads to deportation, which has historically made voluntary testing rates lower among at-risk expat populations due to fear of immigration consequences. The UAE government's position has shifted somewhat in recent years, with public health communications emphasising treatment as prevention. Testing is available at all major UAE labs and is included in visa medical packages conducted at the UAE healthcare regulator-authorised screening centres. Results are treated with strict confidentiality at licensed labs. UAE nationals and residents with HIV are entitled to treatment at government hospitals; the UAE healthcare regulator and the UAE healthcare regulator both run HIV/AIDS treatment programmes.",
  },
};
