  ...
  return (
    <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex items-center gap-3 mb-6 border-b-2 border-[#1c1c1c] pb-3">
        <h2 className="font-['Bricolage_Grotesque',sans-serif] font-medium text-[20px] sm:text-[24px] text-[#1c1c1c] tracking-tight">Labs With Home Collection</h2>
      </div>
        ...
        <table className="w-full text-xs border border-black/[0.06]">
          <thead>
            <tr className="bg-[#f8f8f6]">
              ...
              <th className="text-left p-3 font-bold text-[#1c1c1c] border-b border-black/[0.06]">Home Collection Fee</th>
              <th className="text-left p-3 font-bold text-[#1c1c1c] border-b border-black/[0.06]">Turnaround</th>
              <th className="text-left p-3 font-bold text-[#1c1c1c] border-b border-black/[0.06]">Accreditations</th>
              <th className="text-left p-3 font-bold text-[#1c1c1c] border-b border-black/[0.06]">Cities</th>
            </tr>
          </thead>
          <tbody>
            {homeCollectionLabs
              ...
              .map((lab, i) => (
                <tr key={lab.slug} className={i % 2 === 0 ? "bg-white" : "bg-[#f8f8f6]"}>
                  <td className="p-3 border-b border-black/[0.06]">
                    ...
                    <div className="text-[10px] text-black/40 mt-0.5">{lab.type === "home-service" ? "Home-service platform" : "Lab chain"}</div>
                  </td>
                  <td className="p-3 border-b border-black/[0.06]">
                    {lab.homeCollectionFee === 0 ? (
                      <span className="font-bold text-[#006828]">Free</span>
                    ) : (
                      <span className="font-['Bricolage_Grotesque',sans-serif] font-medium text-[#1c1c1c] tracking-tight">AED {lab.homeCollectionFee}</span>
                    )}
                  </td>
                  <td className="p-3 border-b border-black/[0.06] text-black/40">{lab.turnaroundHours}h</td>
                  ...
                  <td className="p-3 border-b border-black/[0.06]">
                    <div className="flex flex-wrap gap-1">
                      {lab.cities.slice(0, 3).map((c) => (
                        <span key={c} className="text-[10px] bg-[#006828]/[0.04] text-[#006828]-dark px-1.5 py-0.5">
                          {cityLabel(c)}
                        </span>
                      ))}
                      {lab.cities.length > 3 && (
                        <span className="text-[10px] text-black/40">+{lab.cities.length - 3}</span>
                      )}
                    </div>
                  </td>
                </tr>
      ...
      <div className="flex items-center gap-3 mb-6 border-b-2 border-[#1c1c1c] pb-3">
        <h2 className="font-['Bricolage_Grotesque',sans-serif] font-medium text-[20px] sm:text-[24px] text-[#1c1c1c] tracking-tight">How Home Lab Testing Works in the UAE</h2>
      </div>
      <div className="border-l-4 border-[#006828] bg-[#006828]/[0.04] rounded-xl py-5 px-6 mb-6" data-answer-block="true">
      ...
      <div className="flex items-center gap-3 mb-6 border-b-2 border-[#1c1c1c] pb-3">
        <h2 className="font-['Bricolage_Grotesque',sans-serif] font-medium text-[20px] sm:text-[24px] text-[#1c1c1c] tracking-tight">Tests Available for Home Collection</h2>
      </div>
      <div className="border-l-4 border-[#006828] bg-[#006828]/[0.04] rounded-xl py-5 px-6 mb-4" data-answer-block="true">
            ...
            <div className="text-right flex-shrink-0">
              {test.priceRange && (
                <>
                  ...
                  <p className="text-[10px] text-black/40">{test.priceRange.labCount} labs</p>
                </>
              )}
            </div>
          </Link>
      ...
      <div className="flex items-center gap-3 mb-6 border-b-2 border-[#1c1c1c] pb-3">
        <h2 className="font-['Bricolage_Grotesque',sans-serif] font-medium text-[20px] sm:text-[24px] text-[#1c1c1c] tracking-tight">Home Collection Packages</h2>
      </div>
      <div className="border-l-4 border-[#006828] bg-[#006828]/[0.04] rounded-xl py-5 px-6 mb-4" data-answer-block="true">
        <p className="font-['Geist',sans-serif] text-xs text-black/40 mb-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-12">
        {HEALTH_PACKAGES.filter((pkg) => {
          ...
          .map((pkg) => {
            ...
            return (
              <div key={pkg.id} className="border border-black/[0.06] rounded-2xl p-5 hover:border-[#006828]/15 transition-colors">
                <div className="flex items-center gap-2 mb-1">
                  <Home className="w-3.5 h-3.5 text-[#006828]" />
                  <span className="text-[10px] text-black/40 uppercase tracking-wide font-bold">
                    {lab.name}
                  </span>
                  {lab.homeCollectionFee === 0 && (
                    <span className="text-[9px] bg-[#006828]/[0.04] text-[#006828]-dark px-1.5 py-0.5 font-bold">
                      Free collection
                    </span>
                  )}
                </div>
                <h3 className="font-bold text-[#1c1c1c] text-sm mb-1">{pkg.name}</h3>
                <p className="text-[11px] text-black/40 mb-3">{pkg.targetAudience}</p>
                <p className="text-xl font-['Bricolage_Grotesque',sans-serif] font-semibold text-[#1c1c1c] tracking-tight mb-1">{formatPrice(pkg.price)}</p>
                <p className="text-[11px] text-black/40 mb-3">{pkg.biomarkerCount} biomarkers</p>
                <div className="space-y-1">
                  {pkg.includes.slice(0, 4).map((item) => (
                    <div key={item} className="flex items-center gap-1.5 text-xs text-[#1c1c1c]">
      ...
      <div className="flex items-center gap-3 mb-6 border-b-2 border-[#1c1c1c] pb-3">
        <h2 className="font-['Bricolage_Grotesque',sans-serif] font-medium text-[20px] sm:text-[24px] text-[#1c1c1c] tracking-tight">Home Collection vs Walk-In — Which Is Better?</h2>
      </div>
      <div className="border-l-4 border-[#006828] bg-[#006828]/[0.04] rounded-xl py-5 px-6 mb-6" data-answer-block="true">
        <p className="font-['Geist',sans-serif] text-sm text-black/40 leading-relaxed mb-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12">
        ...
        <div className="border border-black/[0.06] p-5">
          <div className="flex items-center gap-2 mb-4">
            <Home className="w-5 h-5 text-[#006828]" />
            <h3 className="font-bold text-[#1c1c1c]">Home Collection</h3>
          </div>
          <div className="space-y-2 mb-4">
            <p className="font-['Geist',sans-serif] text-[11px] font-bold text-black/40 uppercase tracking-wide">Advantages</p>
            {[
              ...
              <div key={item} className="flex items-start gap-2 text-xs text-[#1c1c1c]">
                <CheckCircle className="w-3.5 h-3.5 text-[#006828] flex-shrink-0 mt-0.5" />
                {item}
              </div>
            ))}
          </div>
          <div className="space-y-2">
            <p className="font-['Geist',sans-serif] text-[11px] font-bold text-black/40 uppercase tracking-wide">Limitations</p>
            {[
              ...
              <div key={item} className="flex items-start gap-2 text-xs text-black/40">
                <XCircle className="w-3.5 h-3.5 text-black/40 flex-shrink-0 mt-0.5" />
                {item}
              </div>
            ))}
          </div>
        ...
        <div className="border border-black/[0.06] p-5">
          <div className="flex items-center gap-2 mb-4">
            <MapPin className="w-5 h-5 text-[#006828]" />
            <h3 className="font-bold text-[#1c1c1c]">Walk-In Lab</h3>
          </div>
          <div className="space-y-2 mb-4">
            <p className="font-['Geist',sans-serif] text-[11px] font-bold text-black/40 uppercase tracking-wide">Advantages</p>
            {[
      ...
      <div className="flex items-center gap-3 mb-6 border-b-2 border-[#1c1c1c] pb-3">
        <h2 className="font-['Bricolage_Grotesque',sans-serif] font-medium text-[20px] sm:text-[24px] text-[#1c1c1c] tracking-tight">Home Collection by City</h2>
      </div>
      <div className="border-l-4 border-[#006828] bg-[#006828]/[0.04] rounded-xl py-5 px-6 mb-4" data-answer-block="true">
        <p className="font-['Geist',sans-serif] text-xs text-black/40 mb-4">
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between mb-3">
                <h3 className="font-bold text-[#1c1c1c] group-hover:text-[#006828] transition-colors text-sm">
                  {cityLabel(city)}
                </h3>
                <ArrowRight className="w-4 h-4 text-black/40 group-hover:text-[#006828] transition-colors" />
              </div>
              <div className="space-y-1.5">
                <div className="flex items-center gap-1.5 text-xs text-[#1c1c1c]">
                  <Home className="w-3 h-3 text-[#006828]" />
                  {cityLabs.length} labs with home collection
                </div>
                <div className="flex items-center gap-1.5 text-xs text-[#1c1c1c]">
                  <Wallet className="w-3 h-3 text-[#006828]" />
                  {freeLabs.length} offer free collection
                </div>
              </div>
              <div className="mt-3 flex flex-wrap gap-1">
                {cityLabs.slice(0, 3).map((l) => (
                  <span key={l.slug} className="text-[10px] bg-[#006828]/[0.04] text-[#006828]-dark px-1.5 py-0.5">
                    {l.name.split(" ")[0]}
                  </span>
                ))}
                {cityLabs.length > 3 && (
                  <span className="text-[10px] text-black/40">+{cityLabs.length - 3} more</span>
                )}
              </div>
            </Link>
          );
      ...
      {/* Browse more */}
      <div className="mt-8 border border-black/[0.06] rounded-2xl p-5 flex items-center justify-between gap-4">
        <div>
          <p className="font-['Bricolage_Grotesque',sans-serif] text-sm font-semibold text-[#1c1c1c] tracking-tight">Compare all UAE lab test prices</p>
