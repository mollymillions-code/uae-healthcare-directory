...
//  - Public UAE healthcare licensing categories (pharmacist, dentist, RN, etc.)
...
export const DISCIPLINES: Discipline[] = [
  // ── Physicians ──────────────────────────────────────────────────────────
  { slug: "general-practitioner", role: "physician", name: "General Practitioner", nameAr: "طبيب عام", plural: "General Practitioners", searchIntent: "general practitioner jobs UAE", blurb: "GP/family-medicine roles across UAE clinics. UAE-licensable.", salaryRefAed: { min: 18000, max: 35000 }, licenseAuthority: "shared", dataflowExpected: true },
  { slug: "family-medicine-specialist", role: "physician", name: "Family Medicine Specialist", plural: "Family Medicine Specialists", searchIntent: "family medicine doctor jobs UAE", blurb: "Specialist-grade family-medicine roles, separated from GP grade by board certification or specialist licence.", salaryRefAed: { min: 25000, max: 55000 }, licenseAuthority: "shared", dataflowExpected: true },
  ...
  { slug: "er-nurse", role: "nurse", name: "Emergency Room Nurse", plural: "Emergency Room Nurses", searchIntent: "ER nurse jobs UAE", blurb: "Emergency-department nursing roles across UAE-licensed hospitals.", salaryRefAed: { min: 7000, max: 17000 }, licenseAuthority: "shared", dataflowExpected: true },
  ...
  // ── Pharmacy ────────────────────────────────────────────────────────────
  { slug: "pharmacist", role: "pharmacy", name: "Pharmacist", nameAr: "صيدلي", plural: "Pharmacists", searchIntent: "pharmacist jobs UAE", blurb: "Community, hospital and clinic pharmacist roles. UAE-licensable.", salaryRefAed: { min: 8000, max: 18000 }, licenseAuthority: "shared", dataflowExpected: true },
  ...
  // ── Dental ──────────────────────────────────────────────────────────────
  { slug: "dentist", role: "dental", name: "Dentist", nameAr: "طبيب أسنان", plural: "Dentists", searchIntent: "dentist jobs UAE", blurb: "GP-dentist roles across UAE dental groups. UAE-licensable.", salaryRefAed: { min: 15000, max: 38000 }, licenseAuthority: "shared", dataflowExpected: true },
  ...
  { slug: "dental-assistant", role: "dental", name: "Dental Assistant", plural: "Dental Assistants", searchIntent: "dental assistant jobs UAE", blurb: "Chairside dental-assistant roles. Often assistant-class licensable in the UAE.", salaryRefAed: { min: 4000, max: 8000 }, licenseAuthority: "shared", dataflowExpected: false },
  ...
  { slug: "medical-coder", role: "support", name: "Medical Coder", plural: "Medical Coders", searchIntent: "medical coder jobs UAE", blurb: "ICD-10 / CPT coding roles for clinic groups submitting to UAE insurer panels. CPC / CCS preferred.", salaryRefAed: { min: 6000, max: 13000 }, licenseAuthority: undefined, dataflowExpected: false },
  ...
  { slug: "compliance-officer", role: "management", name: "Compliance Officer", plural: "Compliance Officers", searchIntent: "healthcare compliance officer jobs UAE", blurb: "Healthcare licensing and audit-readiness roles for clinic groups, hospitals and labs in the UAE.", salaryRefAed: { min: 12000, max: 25000 }, licenseAuthority: undefined, dataflowExpected: false },
  { slug: "quality-officer", role: "management", name: "Quality Officer", plural: "Quality Officers", searchIntent: "healthcare quality officer jobs UAE", blurb: "JCI / ISO / quality-programme roles for hospitals and large clinic groups.", salaryRefAed: { min: 12000, max: 25000 }, licenseAuthority: undefined, dataflowExpected: false },
